...
export const HeroHeader2 = () => {
    return (
        <div className="px-4 py-16 mx-auto sm:w-full md:px-24 lg:px-8 lg:py-20 dark:bg-gray-900 bg-gradient-to-br from-orange-300 via-red-500 to-yellow-500">
            <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row max-w-screen-xl mx-auto">
                <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5 text-center lg:text-left">
                    <div className="max-w-xl mb-6">
                        <h2 className="font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none max-w-lg mb-6 dark:text-white">
                            Private Sauna
                        </h2>
